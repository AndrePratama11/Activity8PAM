...
public class TambahTeman extends AppCompatActivity {
    ...
    private static String url_insert = "https://20200140075.praktikumtiumy.com/tambahtm.php";
    ...
    private void callHome() {
        Intent i = new Intent(TambahTeman.this, kelas.b.activity8.MainActivity.class);
        startActivity(i);
        finish();
    }
}